> 원본 URL: https://openapi.tossinvest.com/openapi-docs/latest/api-reference/Models/SecuritiesLendingResponse.md
> 문서 버전: 1.2.17
...
| **records** | [**List**](MODEL_SECURITIES_LENDING_RECORD.md) | 일별 대차거래 기록 목록 (최신순). 데이터가 없으면 빈 배열 | [default to null] |
...
일별 대차거래 기록 목록 (최신순). 데이터가 없으면 빈 배열
