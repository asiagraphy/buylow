> 원본 URL: https://openapi.tossinvest.com/openapi-docs/latest/api-reference/Models/ShortSellingResponse.md
> 문서 버전: 1.2.17
...
| **records** | [**List**](MODEL_SHORT_SELLING_RECORD.md) | 일별 공매도 기록 목록 (최신순). 데이터가 없으면 빈 배열 | [default to null] |
...
일별 공매도 기록 목록 (최신순). 데이터가 없으면 빈 배열
