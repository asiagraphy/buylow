> 원본 URL: https://openapi.tossinvest.com/openapi-docs/latest/api-reference/Models/MarketIndicatorCandlePageResponse.md
> 문서 버전: 1.2.17
...
|------------ | ------------- | ------------- | -------------|
| **candles** | [**List**](MODEL_MARKET_INDICATOR_CANDLE.md) | 캔들 목록. 최신순(`timestamp` 내림차순) 정렬 — 배열 첫 요소가 가장 최근 봉, 마지막 요소가 가장 오래된 봉입니다. | [default to null] |
